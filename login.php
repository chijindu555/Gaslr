                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="post" action="validator.php">
                                                    ...
                                                    <a href="pages/parts/register.php" class="btn btn-outline-primary float-left btn-inline">Register</a>
                                                    <button name="login" type="submit" class="btn btn-primary float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
